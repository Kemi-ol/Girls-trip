      ...
      <div className="zagreb-content">
        ...
        <div className="zagreb-column">
          <button className="zagreb-button">
            <a href="https://www.loveholidays.com/holidays/?destinationIds=2249&departureAirports=LON&nights=3&rooms=2&date=2024-07-05&flexibility=0&sort=POPULAR&f.boardBasis=BB&f.pools=Indoor%20Pool" target="_blank" rel="noreferrer"> View Search results </a>
          </button>
